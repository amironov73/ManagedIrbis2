        ...
        : IDisposable
    {
        ...
        public string DatabasePftPath
        {
            get
            {
                ...
                string systemPath = Configuration.SystemPath.ThrowIfNull("SystemPath");
                string result = Path.Combine(systemPath, pftPath);
        ...
        {
            Sure.NotNullNorEmpty(databasePath, nameof(databasePath));
        ...
        {
            Sure.NotNull(startTerm, nameof(startTerm));
            ...
            )
        {
            ...
            SearchTokenList tokens = SearchQueryLexer.Tokenize(expression);
        ...
        {
            Sure.NotNullNorEmpty(iniFile, nameof(iniFile));
