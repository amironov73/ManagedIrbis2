...
namespace AM.Drawing.Printing
{
        ...
        IVerifiable
    {
            ...
            )
        {
            ...
            PrinterDefinition result = JsonUtility.ReadObjectFromFile<PrinterDefinition>
                (
                    fileName
                );
            ...
            )
        {
            ...
            {
                XmlSerializer serializer = new XmlSerializer(typeof(PrinterDefinition));

                return (PrinterDefinition)serializer.Deserialize(stream);
            }
        }
