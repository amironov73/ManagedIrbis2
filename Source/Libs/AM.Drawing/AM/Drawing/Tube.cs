...
namespace AM.Drawing
{
        ...
        IXmlSerializable
    {
        ...
        /// </summary>
        public static implicit operator Brush([NotNull] Tube tube) => tube.Brush;

        /// <summary>
        /// Performs an implicit conversion from
        /// <see cref="Tube"/> to <see cref="System.Drawing.Pen"/>.
        /// </summary>
        public static implicit operator Pen([NotNull] Tube tube) => tube.Pen;

        /// <summary>
        /// Performs an implicit conversion from
        /// <see cref="Tube"/> to <see cref="System.Drawing.Color"/>.
        /// </summary>
        public static implicit operator Color([NotNull] Tube tube) => tube.Color;
