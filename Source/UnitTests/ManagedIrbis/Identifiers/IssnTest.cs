...
namespace UnitTests.ManagedIrbis.Identifiers
{
    ...
    public class IssnTest
    {
        ...
        {
            Assert.AreEqual('X', Issn.ComputeCheckDigit("0033765X".ToCharArray()));
        }

        [TestMethod]
        public void Issn_CheckControlDigit_1()
        {
            Assert.IsTrue(Issn.CheckControlDigit("0033765X".ToCharArray()));
            Assert.IsFalse(Issn.CheckControlDigit("00337651".ToCharArray()));
        }
