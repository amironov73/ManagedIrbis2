...
namespace AM.Drawing
{
    ...
    public static class FontUtility
    {
        ...
        {
            Sure.NotNullNorEmpty(fontSpecification, nameof(fontSpecification));
            ...
            GraphicsUnit unit = (GraphicsUnit)Enum.Parse(typeof(GraphicsUnit), parts[2]);
